...
ActiveRecord::Schema.define(version: 2020_02_27_121303) do
  ...
  create_table "google_calendars", force: :cascade do |t|
    ...
    t.string "remote_id"
    t.index "user_id, lower((name)::text)", name: "unique_index_google_calendars_on_lowercase_name_and_user_id", unique: true
  ...
  create_table "outbound_event_configs", force: :cascade do |t|
    ...
    t.index ["owner_id"], name: "index_outbound_event_configs_on_owner_id"
  ...
  add_foreign_key "outbound_event_configs", "users", column: "owner_id"
